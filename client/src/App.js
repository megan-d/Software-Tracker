    ...
    <Router>
      ...
      <div className='full-page'>
        <Switch>
          ...
          <PrivateRoute path='/projects/tickets/:ticketid/updateticket' component={UpdateTicket} exact />
          <PrivateRoute path='/projects/tickets/:ticketid/comment' component={CommentTicket} exact />
